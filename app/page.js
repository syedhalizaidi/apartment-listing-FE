  ...
  const features = [
    {
      ...
      description:
        "Find your perfect apartment with intelligent recommendations across 15+ Japanese real estate sites",
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Duplicate Detection",
      description:
        "No more seeing the same listing multiple times - we automatically remove duplicates",
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Real-Time Results",
      description:
        "Get instant updates from all major Japanese rental platforms",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Search across 15+ Japanese real estate sites with AI-powered
              recommendations. No duplicates, no hassle - just the perfect
              apartment for you.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We&apos;ve revolutionized apartment hunting in Japan with
              cutting-edge technology and comprehensive coverage.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 bg-blue-100 rounded-xl flex items-center justify-center mb-6 transition-colors ${
                    isHovered === index
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We aggregate listings from all major Japanese rental platforms to
              give you the most comprehensive search experience.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {realEstateSites.map((site, index) => (
              ...
              >
                <div
                  className={`w-12 h-12 ${site.color} rounded-lg flex items-center justify-center mb-4 mx-auto`}
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Describe your ideal apartment - location, budget, bedrooms, and
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our AI searches across 15+ Japanese real estate sites and
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Select your favorites and schedule tours directly through our
                platform.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of people who have found their perfect home with
            Apartment Finder.
          </p>
          <Link href="/listing">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>
              &copy; 2024 Apartment Finder. All rights reserved. Built with ❤️
              for apartment hunters in Japan.
            </p>
          </div>
        </div>
      </footer>
